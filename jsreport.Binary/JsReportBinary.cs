...
namespace jsreport.Binary.Ph2
{
    public class JsReportBinary
    {
        ...
        public static IReportingBinary GetBinary()
        {
            ...
            return new ReportingBinary("ph2-" + assembly.GetName().Version.ToString(),
                () =>
                {
                    var zip = new ZipArchive(assembly.GetManifestResourceStream("jsreport.Binary.Ph2.jsreport.zip"));
